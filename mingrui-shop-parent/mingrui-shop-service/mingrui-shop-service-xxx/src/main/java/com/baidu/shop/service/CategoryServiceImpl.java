...
public class CategoryServiceImpl extends BaseApiService implements CategoryService {
    ...
    @Override
    public Result<List<CategoryEntity>> getCategoryByIds(String cateIds) {

        String[] idArr = cateIds.split(",");

        List<Integer> cateIdList = Arrays.asList(idArr).stream().map(idStr -> {
